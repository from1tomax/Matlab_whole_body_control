...
J_init_wb = get_J(q_0(1:3), q_0(4:10));
J_init = J_init_wb(:,4:10);
% External Force
tau_ext = [0 0 0 0 0 0 0]';

% CONTROLLER PARAMETERS
% Cartesian Controller (Primary Task)
% PERFECT TRACKING PARAMETERS
Kc = diag(50*[100;100;100;100;100;100]); %STIFFNESS
%K_d = diag([150;180;105;1.5;15;52.5]); % D_d = diag([180;200;80;10;10;6]);

% Null-space Controller (Secondary task)
Kv = [30; 30; 30; 30; 30; 30; 30; 30; 30; 30]; % [30; 0; 0; 30; zeros(6,1)]; [50*ones(2,1); 100; 3*[100; 100; 50; 100; 50; 100; 100]];
Kp = [0; 0; 0; 40; zeros(3,1)]; %[400;400*ones(6,1)]; 
...
p_f = [p_i(1)-0.3;p_i(2)-0.3; p_i(3)]; %[p_i(1)-0.3;p_i(2)-0.3; p_i(3)];
T_f(1:3,1:3) = eul2rotm([0,0,pi/6], 'XYZ')*T_i(1:3,1:3); %T_i(1:3,1:3); %
T_f(1:4,4) = [p_f;1];
...
am_r = 0.3;
%return;
open("RB_KAIROS_ArmOnly.slx");
sim("RB_KAIROS_ArmOnly.slx");
...
q_v = qv.Data(1, 1:end); %q_v is a constant
for i = 1:length(t)-1
...
ylim([-5 5])
zlim([0 1.5])
set(gcf, 'WindowState', 'maximize'); % Opens figure in full screen
